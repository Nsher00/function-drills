...
//CODE HERE
let add =(num1,num2)=> console.log(Number(num1) + Number(num2));
let sum = add('8',9)
////////////////// PROBLEM 7 ////////////////////
...
*/
let exclaimThree=(str)=>console.log(`${str.toUpperCase()}!!!`);
exclaimThree("FANTASIC")
...
//CODE HERE
let nameCheck =(name)=>{
  let nameParam = name === 'Steven' ? `What's up ${name}!`
  : name === 'Bryan' ? `Hey ${name}!`
  : `Cool name, ${name}`;
